      ...
      <div className="p-10 flex flex-col flex-grow">
        ...
        <div className="mt-auto pt-8 border-t border-gray-50 flex items-center justify-between">
          <div className="flex flex-col">
            <span className="text-[10px] text-gray-400 font-bold uppercase tracking-[0.3em] mb-1">Standard Fee</span>
            <span className="text-2xl font-black text-[#020617]">₹{service.price}</span>
          </div>
